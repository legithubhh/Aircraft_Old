...
typedef enum {
    ...
    ID_aerial_bullet = 0x0208,              // 允许发弹量
    ID_command_data = 0x0304,
...
typedef struct
{
    uint16_t Small_bullet;
    uint16_t Big_bullet;
    uint16_t coin_number;
} ext_bullet_data_t;
/***************裁判系统数据********************/
/*
...
typedef struct
{
    ...
    ext_bullet_data_t BulletData;                           // 0x0208
